...
class PredictionPage(tk.Frame):
    ...
    def set_sport(self, sport: str) -> None:
        ...
        if hasattr(self, "category_combo"):
            if sport == "Football":
                self.category_combo["values"] = ["International", "Club"]
                self.category_var.set("International")
            else:
                self.category_combo["values"] = ["T20I", "T20 Franchise", "ODI", "Test"]
                self.category_var.set("T20I")
    ...
    def _build_controls(self, parent: tk.Widget) -> None:
        ...
        self.category_combo.bind("<<ComboboxSelected>>", lambda e: self._update_team_lists())

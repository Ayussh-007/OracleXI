...
DATASET_SCHEMAS: Dict[str, List[str]] = {
    "football_results": ["date", "home_team", "away_team", "home_score", "away_score", "tournament"],
    "cricket_match_info": ["match_id", "date", "team1", "team2", "winner", "format"],
    "cricket_ball_by_ball": ["match_id", "batting_team", "bowling_team", "total_run"],
    "football_rankings": ["rank", "team", "total_points"],
    "football_goalscorers": ["date", "home_team", "away_team", "team", "scorer", "minute"],
    "cricket_player_stats": ["match_id", "player", "team", "runs", "wickets", "tournament"],
}
